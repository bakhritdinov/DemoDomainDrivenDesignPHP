...
readonly class FindCurrencyByIdDeactivatedQueryHandler implements QueryHandler
{
    public function __construct(public CurrencyRepositoryInterface $repository)
    {
    }

    public function __invoke(FindCurrencyByIdDeactivatedQuery $query): ?Currency
    {
        return $this->repository->ofIdDeactivated($query->getCurrencyId());
    }
}