...
class FindLanguageByIdQueryHandler implements QueryHandler
{
    public function __construct(public LanguageRepositoryInterface $repository)
    {
    }

    public function __invoke(FindLanguageByIdQuery $query): ?Language
    {
        return $this->repository->ofId($query->getLanguageId());
    }
}