...
class UpdateCurrencyConsoleCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $currencyId = $helper->ask($input, $output, $choiceList);

        /**
         * Set new code for selected currency
         */
        $setCodeQuestion = new Question("Set new code (press enter for skip stage) \n", null);
        ...
        /**
         * Set new num for selected currency
         */
        $setNameQuestion = new Question("Set new num (press enter for skip stage) \n", null);
        $setNameQuestion->setValidator(function ($answer) {
        ...
        $num = $helper->ask($input, $output, $setNameQuestion);
        ...
        $this->commandBus->dispatch(new UpdateCurrencyCommand($currencyId, new UpdateCurrencyDto($code, $num, $name, $isActive)));
