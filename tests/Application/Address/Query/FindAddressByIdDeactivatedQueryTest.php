...
use App\Application\Address\Query\FindAddressByIdDeactivatedQueryHandler;
...
class FindAddressByIdDeactivatedQueryTest extends MessageBusTestCase
{
    ...
    public function testQueryInstanceOf()
    {
        $this->assertInstanceOf(
            Query::class,
            new FindAddressByIdDeactivatedQuery(Uuid::v1())
        );
        $this->assertInstanceOf(
            QueryHandler::class,
            $this->getContainer()->get(FindAddressByIdDeactivatedQueryHandler::class)
        );
    }

    public function testFindAddressByIdDeactivatedQueryHandler()
    {
        ...
        $findAddress = $container->get(FindAddressByIdDeactivatedQueryHandler::class)(
            new FindAddressByIdDeactivatedQuery($address->getId())
        );
