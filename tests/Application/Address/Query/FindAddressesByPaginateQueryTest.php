...
use App\Application\Address\Query\FindAddressesByPaginateQueryHandler;
...
class FindAddressesByPaginateQueryTest extends MessageBusTestCase
{
    ...
    public function testQueryInstanceOf()
    {
        $this->assertInstanceOf(
            Query::class,
            new FindAddressesByPaginateQuery(1, 1)
        );
        $this->assertInstanceOf(
            QueryHandler::class,
            $this->getContainer()->get(FindAddressesByPaginateQueryHandler::class)
        );
    }
    ...
    public function testFindCountriesByPaginateQueryHandler()
    {
        ...
        $addresses = $container->get(FindAddressesByPaginateQueryHandler::class)(
            new FindAddressesByPaginateQuery(1, 2)
        );
