...
use App\Application\Address\Query\FindAllAddressesQuery;
use App\Application\Address\Query\FindAllAddressesQueryHandler;
...
class FindAllAddressesQueryTest extends MessageBusTestCase
{
    ...
    public function testQueryInstanceOf()
    {
        $this->assertInstanceOf(
            Query::class,
            new FindAllAddressesQuery()
        );
        $this->assertInstanceOf(
            QueryHandler::class,
            $this->getContainer()->get(FindAllAddressesQueryHandler::class)
        );
    }
    ...
    public function testFindAllCountriesQueryHandler()
    {
        ...
        $addresses = $container->get(FindAllAddressesQueryHandler::class)(
            new FindAllAddressesQuery()
        );
