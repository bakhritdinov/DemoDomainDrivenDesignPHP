...
use App\Application\City\Query\FindCitiesByPaginateQueryHandler;
...
class FindCitiesByPaginateQueryTest extends MessageBusTestCase
{
    ...
    public function testQueryInstanceOf()
    {
        $this->assertInstanceOf(
            Query::class,
            new FindCitiesByPaginateQuery(1, 1)
        );
        $this->assertInstanceOf(
            QueryHandler::class,
            $this->getContainer()->get(FindCitiesByPaginateQueryHandler::class)
        );
    }
    ...
    public function testFindCountriesByPaginateQueryHandler()
    {
        ...
        $cities = $container->get(FindCitiesByPaginateQueryHandler::class)(
            new FindCitiesByPaginateQuery(1, 2)
        );
