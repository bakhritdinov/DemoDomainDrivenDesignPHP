...
use App\Application\City\Query\FindCityByRegionAndTypeAndNameDeactivatedQuery;
use App\Application\City\Query\FindCityByRegionAndTypeAndNameDeactivatedQueryHandler;
...
class FindCityByRegionAndRegionAndTypeAndNameDeactivatedQueryTest extends MessageBusTestCase
{
    ...
    public function testQueryInstanceOf()
    {
        $this->assertInstanceOf(
            Query::class,
            new FindCityByRegionAndTypeAndNameDeactivatedQuery(RegionFixture::getOne(CountryFixture::getOne()), 'city', 'Moscow')
        );
        $this->assertInstanceOf(
            QueryHandler::class,
            $this->getContainer()->get(FindCityByRegionAndTypeAndNameDeactivatedQueryHandler::class)
        );
    }
    ...
    public function testFindCityByRegionAndCodeQueryHandler()
    {
        ...
        $city = $container->get(FindCityByRegionAndTypeAndNameDeactivatedQueryHandler::class)(
            new FindCityByRegionAndTypeAndNameDeactivatedQuery($region, $city->getType(), $city->getName())
        );
