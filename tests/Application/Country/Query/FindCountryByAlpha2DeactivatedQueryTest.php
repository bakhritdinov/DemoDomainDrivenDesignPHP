...
use App\Application\Country\Query\FindCountryByAlpha2DeactivatedQuery;
use App\Application\Country\Query\FindCountryByAlpha2DeactivatedQueryHandler;
...
class FindCountryByAlpha2DeactivatedQueryTest extends MessageBusTestCase
{
    ...
    public function testQueryInstanceOf()
    {
        $this->assertInstanceOf(
            Query::class,
            new FindCountryByAlpha2DeactivatedQuery("RU")
        );
        $this->assertInstanceOf(
            QueryHandler::class,
            $this->getContainer()->get(FindCountryByAlpha2DeactivatedQueryHandler::class)
        );
    }

    public function testFindCountryByAlpha2DeactivatedQueryHandler()
    {
        ...
        $country = $container->get(FindCountryByAlpha2DeactivatedQueryHandler::class)(
            new FindCountryByAlpha2DeactivatedQuery($country->getAlpha2())
        );
