...
use App\Application\Country\Query\FindCountryByAlpha3Query;
use App\Application\Country\Query\FindCountryByAlpha3QueryHandler;
...
class FindCountryByAlpha3QueryTest extends MessageBusTestCase
{
    ...
    public function testQueryInstanceOf()
    {
        $this->assertInstanceOf(
            Query::class,
            new FindCountryByAlpha3Query(123)
        );
        $this->assertInstanceOf(
            QueryHandler::class,
            $this->getContainer()->get(FindCountryByAlpha3QueryHandler::class)
        );
    }

    public function testFindCountryByAlpha3QueryHandler()
    {
        ...
        $country = $container->get(FindCountryByAlpha3QueryHandler::class)(
            new FindCountryByAlpha3Query($country->getAlpha3())
        );
