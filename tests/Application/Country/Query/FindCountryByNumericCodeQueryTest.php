...
use App\Application\Country\Query\FindCountryByNumericCodeQueryHandler;
...
class FindCountryByNumericCodeQueryTest extends MessageBusTestCase
{
    ...
    public function testQueryInstanceOf()
    {
        $this->assertInstanceOf(
            Query::class,
            new FindCountryByNumericCodeQuery(123)
        );
        $this->assertInstanceOf(
            QueryHandler::class,
            $this->getContainer()->get(FindCountryByNumericCodeQueryHandler::class)
        );
    }

    public function testFindCountryByNumericCodeQueryHandler()
    {
        ...
        $country = $container->get(FindCountryByNumericCodeQueryHandler::class)(
            new FindCountryByNumericCodeQuery($country->getNumericCode())
        );
