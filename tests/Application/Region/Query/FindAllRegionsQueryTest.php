...
use App\Application\Region\Query\FindAllRegionsQuery;
use App\Application\Region\Query\FindAllRegionsQueryHandler;
...
class FindAllRegionsQueryTest extends MessageBusTestCase
{
    ...
    public function testQueryInstanceOf()
    {
        ...
        $this->assertInstanceOf(
            QueryHandler::class,
            $this->getContainer()->get(FindAllRegionsQueryHandler::class)
        );
    }
    ...
    public function testFindAllCountriesQueryHandler()
    {
        ...
        $regions = $container->get(FindAllRegionsQueryHandler::class)(
            new FindAllRegionsQuery()
        );
