...
use App\Application\Region\Query\FindRegionByCodeDeactivatedQueryHandler;
...
class FindRegionByCodeDeactivatedQueryTest extends MessageBusTestCase
{
    ...
    public function testQueryInstanceOf()
    {
        $this->assertInstanceOf(
            Query::class,
            new FindRegionByCodeDeactivatedQuery('RU')
        );
        $this->assertInstanceOf(
            QueryHandler::class,
            $this->getContainer()->get(FindRegionByCodeDeactivatedQueryHandler::class)
        );
    }

    public function testFindRegionByCodeDeactivatedQueryHandler()
    {
        ...
        $region = $container->get(FindRegionByCodeDeactivatedQueryHandler::class)(
            new FindRegionByCodeDeactivatedQuery($region->getCode())
        );
